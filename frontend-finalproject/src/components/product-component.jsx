  ...
  return (
    <div>
      <div className="relative group overflow-hidden hover:opacity-85" style={{ width: '100%', height: '100%', fontFamily: "ALEGREYA-NORMAL" }}>
        ...
        <div onClick={(e) => { addToCart(id); e.stopPropagation() }} className="px-1 py-1 flex justify-center items-center opacity-0 group-hover:opacity-100 duration-300 ease-in-out">
          <button className="bg-white text-[#EF2840] px-10 py-2 border-2 hover:bg-[#EF2840] hover:text-white focus:outline-none" style={{ fontSize: '12px', borderColor: '#EF2840', borderStyle: 'solid' }}>
            THÊM VÀO GIỎ
          </button>
        </div>
