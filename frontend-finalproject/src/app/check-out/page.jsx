...
const CheckOutPage = () => {
  ...
  return (
    <div className="h-screen bg-white-100 pt-20" style={{fontFamily: "ALEGREYA-NORMAL"}}>
        ...
        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          {paymentMethod === "cod" ? (
            <button
              ...
              className="mt-6 w-full rounded-md bg-[#EF2840] py-1.5  text-blue-50 hover:bg-[#a2313e]"
            >
              HOÀN TẤT THANH TOÁN
            </button>
          ) : (
