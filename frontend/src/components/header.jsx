        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            {!localUser ? (
              ...
              <div className="relative">
                <div className="cursor-pointer" onClick={() => setUserMenu(!userMenu)}>
                  {localUser.image ? (
                    <img src={localUser.image} className="w-7 h-7 rounded-full" alt="User Profile" />
                  ) : (
                    <FontAwesomeIcon icon={faUser} className="mt-1 w-5 h-5 rounded-full" />
                  )}
                </div>
                {userMenu && (
                  <div className="absolute right-0 mt-2 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" style={{ fontFamily: "ALEGREYA-NORMAL" }}>
                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                      <li>
                        <a href="my-profile" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style={{ fontFamily: "ALEGREYA-NORMAL", fontSize: "16px" }}>
                          Thông tin cá nhân
                        </a>
                      </li>
                      <li>
                        <Link href="/my-orders" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style={{ fontFamily: "ALEGREYA-NORMAL", fontSize: "16px" }}>
                          Đơn hàng
                        </Link>
                      </li>
                      <li>
                        <button onClick={() => logout()} className="block w-full text-start px-4 py-2 bg-transparent text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" style={{ fontFamily: "ALEGREYA-NORMAL", fontSize: "16px" }}>
                          Đăng xuất
                        </button>
                      </li>
                    </ul>
            ...
            {localUser && (
              <Link href="/shopping-cart" className="ml-5 relative">
